    ...
    if (model1.type == "linear") {
        ...
        if(model2.type == "linear"){
            ...
            return {
                ...
                equation: [customRound(a), customRound(b)],
            };
        }
        ...
        if(model2.type == "power"){
            ...
            return {
                ...
                equation: [customRound(a), customRound(b), customRound(c)],
            };
        }
        if (model2.type == "exponential"){
            let b = model2.equation[1];
            let c = model1.equation[1] * (-1) / model1.equation[0];
            return {
                xQ: model2.xQ,
                yQ: model1.xQ,
                type: model2.type,
                ...
                calcValue: function(value){
                    return this.equation[0] * Math.exp(this.equation[1] * value) + this.equation[2]
                },
                equation: [customRound(a), customRound(b), customRound(c)],
            };
        }
    ...
    if (model1.type == "exponential") {
        if (model2.type == "linear") {
            ...
            return {
                ...
                type: "logarithmic",
                getFormula: function () {
                    return `${this.yQ}(${this.xQ}) = ${this.equation[0]}⋅ln(${this.equation[1]}⋅${this.xQ} + ${this.equation[2]})`;
                },
                calcValue: function(value){
        ...
        if (model2.type == "exponential") {
            ...
            let b = (Math.log(model2.equation[0]) - Math.log(model1.equation[0])) / model1.equation[1];
            return {
                xQ: model2.xQ,
                yQ: model1.xQ,
                type: "linear",
    ...
    if (model1.type == "power") {
        ...
        if (model2.type == "logarithmic") {
            ...
            return {
                ...
                type: "logarithmic",
                getFormula: function () {
                    return `${this.yQ}(${this.xQ}) = (${this.equation[0]}⋅ln(${this.xQ}) + ${this.equation[1]})^${this.equation[2]}`;
                },
                calcValue: function(value){
                    return Math.pow(this.equation[0] * Math.log(value) + this.equation[1], this.equation[2])
                },
                equation: [customRound(a), customRound(b), customRound(c)],
            };
        }
