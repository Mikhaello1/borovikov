    ...
    return (
        <div style={{ fontSize: "22px" }}>
            ...
            <div style={{ margin: "10px" }}>
                ...
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;Для нахождения функции пересчёта (имитационной модели) {factor}
                    <sub>им</sub> = f(t) необходимо приравнять друг к другу полученные с ипользованием обучающей выборки математические выражения, а затем решить полученное
                    уравнение: {parameter}({factor}) = {parameter}(t) и выразить {factor} от t.
                </p>
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;Имитационная модель для найденных ранее математических выражений (1), (2) из средних значений параметра {parameter} в зависимости от{" "}
                    {factor} и t:{" "}
                </p>
                <div style={{ textAlign: "center", fontSize: "24px" }}>
                    {factor}
                    <sub>им</sub>(t) ={" "}
                    {typeof recalcMathModel?.getFormula == "function"
                        ? getExpressionAfterEquals(simplifyEquation(recalcMathModel?.getFormula(), recalcMathModel.yQ, recalcMathModel.xQ))
                        : "idi nahuy"}
                </div>
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;Имитационная модель используется для расчёта имитационного значения фактора, которое вызывает примерно такое же изменение параметра, как
                    и заданная наработка t.
                </p>
            </div>
        </div>
    );
