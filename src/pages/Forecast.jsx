...
export default function Forecast() {
    ...
    let trulyYValues = tValues.map((t) => {
    ...
    let forecastValues = tValues.map((t) =>
    ...
    const handleTValueChange = (value, index) => {
        let newValue = value;
        newValue ||= 1;
    ...
    const handleCalcError = () => {
        let errors = forecastValues.map((el, index) => {
            return calcForecastError(el, trulyYValues[index])
        })
        console.log(errors)
